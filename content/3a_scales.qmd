...
One option is to specify the bin edges in a consistent way (for instance, using `beta_bins(30)`).
:::
...
As we can see, **Ordered Beta models** are flexible and more appropriate to the type of data often observed in psychology. 
